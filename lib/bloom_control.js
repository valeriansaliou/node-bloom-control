...
BloomControl.prototype.__emit = function(command, done, client) {
  ...
  if (this.__client !== null || client) {
    ...
    (client || this.__client).write(this.__lastCommand + "\n");
  } else {
...
BloomControl.prototype.__triggerResponseHandler = function(type) {
  if (typeof this.__responseHandlers[type] === "function") {
    this.__responseHandlers[type](this.__lastCommand);
  }
};
...
/**
 * BloomControl.prototype.__handleDataLine_nil
 * @private
 * @param  {object} client
 * @param  {string} argument
 * @return {undefined}
 */
BloomControl.prototype.__handleDataLine_nil = function(client, argument) {
  this.__triggerResponseHandler("NIL");
};


/**
 * BloomControl.prototype.__handleDataLine_ok
 * @private
 * @param  {object} client
 * @param  {string} argument
 * @return {undefined}
 */
BloomControl.prototype.__handleDataLine_ok = function(client, argument) {
  this.__triggerResponseHandler("OK");
};


/**
 * BloomControl.prototype.__handleDataLine_err
 * @private
 * @param  {object} client
 * @param  {string} argument
 * @return {undefined}
 */
BloomControl.prototype.__handleDataLine_err = function(client, argument) {
  this.__triggerResponseHandler("ERR");
};
